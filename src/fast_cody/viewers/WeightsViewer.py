...
class WeightsViewer():
    ...
    def __init__(self, V, F, W,
        ...
        print("WARNING: WeightsViewer is disabled - polyscope conflicts with fast_cd_pyb GLFW on macOS")
        print("         This viewer would visualize weights using polyscope, but is currently disabled.")
        ...
        self.path = path
        self.mesh = None  # Placeholder - polyscope mesh would be registered here
        # if F.shape[1] == 1:
        ...
        if (P is not None):
            ...
            self.bone_mesh = None  # Placeholder
            alpha = 0.5
    ...
    def anim(self):
        # polyscope disabled because it conflicts with fast_cd_pyb GLFW on macOS
        print("WARNING: WeightsViewer.anim() called but polyscope is disabled")
        return
